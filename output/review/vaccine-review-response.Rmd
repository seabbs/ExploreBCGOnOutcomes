...
*We have moved both S1 and S2 into the main body of the text. The tables are presented seperately to make it clear that not all outcomes were considered in the same model. Whilst this is our prefered method of presenting this data we would be happy to combine these tables into a single table if required.*
